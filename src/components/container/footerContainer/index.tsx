...
export const FooterContainer: React.FC = () => {
  return (
    <S.Container style={{ width: "99.2vw" }}>
      ...
      >
        <div>
          <img src="https://eduinfrabrasil.vercel.app/logo.png" alt="" sizes="" />
        </div>
        <div>
          ...
          <div>
            <ul style={{ display: "flex" }}>
              <S.PX8 className="px-8">
                <a href="#">
                  <img src="https://eduinfrabrasil.vercel.app/icons/social/Facebook.png" alt="" />
                </a>
              </S.PX8>
              <S.PX8 className="px-8">
                <a href="#">
                  <img src="https://eduinfrabrasil.vercel.app/icons/social/Twitter.png" alt="" />
                </a>
              </S.PX8>
              <S.PX8 className="px-8">
                <a href="#">
                  <img src="https://eduinfrabrasil.vercel.app/icons/social/Instagram.png" alt="" />
                </a>
              </S.PX8>
              <S.PX8 className="px-8">
                <a href="#">
                  <img src="https://eduinfrabrasil.vercel.app/icons/social/LinkedIn.png" alt="" />
                </a>
              </S.PX8>
              <S.PX8 className="px-8">
                <a href="#">
                  <img src="https://eduinfrabrasil.vercel.app/icons/social/YouTube.png" alt="" />
                </a>
              </S.PX8>
            </ul>
          </div>
